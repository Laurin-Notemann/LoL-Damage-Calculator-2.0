...
def get_amp_based_on_missing_health(enemy_missing_health_perc,  damage_amplifier_missing_health_static, missing_health_iterator_static,
                                    missing_health_cap):
    missing_health_iterator = missing_health_iterator_static/2500
    damage_amplifier_missing_health = damage_amplifier_missing_health_static/2500
    ...
    for i in range(0, int((missing_health_cap / missing_health_iterator)) + 1):
        if enemy_missing_health_perc < missing_health_iterator_static:
            ...
            break
        missing_health_iterator = missing_health_iterator + missing_health_iterator_static
        damage_amplifier_missing_health = damage_amplifier_missing_health + \
            damage_amplifier_missing_health_static
